...
try:
    ...
    raise SystemExit(f"JSON file not found: {JSON_FILE_PATH}. Run SEC_company_tickers_exchange.py first.")
except json.JSONDecodeError as e:
    raise SystemExit(f"Failed to parse JSON file {JSON_FILE_PATH}: {e}")
